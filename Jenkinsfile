pipeline {
    ...
    stages {
        ...
        stage('Save artifacts') {
            ...
            post {
                success {
                    sh 'curl -d \'{"chat_id": "-1002185373712", "text": "Дмитрий Третьяков собрал приложение."}\' -X POST -H "Content-type: application/json" https://api.telegram.org/bot5933756043:AAE8JLL5KIzgrNBeTP5e-1bkbJy4YRoeGjs/sendMessage'
                }
            }
        }
    }
